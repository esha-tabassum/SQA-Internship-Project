...
- [Week 1 Test Cases](./Week-1/SQA_Week1_TestCases.pdf) - Manual test cases for SauceDemo login system (8 test cases)
- [Week 1 Bug Report](./Week-1/SQA_Week1_BugReport.pdf) - Jira bug reports for identified issues (3 bugs)
...
- **Automation Scripts:**
  - [Login Automation](./Week-3/Automation-Scripts/login_test.py) - Selenium script for login validation
  - [Dashboard Automation](./Week-3/Automation-Scripts/dashboard_test.py) - Selenium script for product sorting (Z-A)
  - [Login Success Screenshot](./Week-3/Automation-Scripts/login_success.png) - Screenshot of successful login
...
## 🔗 Quick Links
- [Week 1 Test Cases](./Week-1/SQA_Week1_TestCases.pdf)
- [Week 1 Bug Report](./Week-1/SQA_Week1_BugReport.pdf)
- [Week 2 Test Plan](./Week-2/SQA_Week2_TestPlan.pdf)
...
- Black-box testing techniques (BVA, EP)
...
## 📌 Recommendations
1. Fix identified bugs (mobile overlap, forgot password, password toggle)
